...
module.exports.DB = klass(EventTarget, ReadyStateFul, statics => {
    ...
    const queue = (instance, resolveHandler) => function(){
        dbs.get(this).set("queue", dbs.get(this).get("queue").then(() => new Promise((resolve, reject) => {
            const onidle = () => Promise.resolve()
                                    .then(resolveHandler, reject)
                                    .then(resolve, reject)
            const onreadystatechange = ({readystate}) => {
                if ( readystate < module.exports.DB.IDLE )
                  return
            ...
            if ( this.readyState >= module.exports.DB.IDLE )
              onidle()
            else
    ...
    return {
        constructor: function(dict){
            ...
            dbs.get(this).set("queue", Promise.resolve())
            ...
            dbs.get(this).set("ready", Promise.resolve()
                ...
                .then(() => new Promise(resolve => {
                    /*
                        .fsdb file read
                    */
                    const input = createReadStream( dict.config || resolvePath(cwd, "./.fsdb") )
                ...
                .then(opts => new Promise((resolve, reject) => {
                    ...
                    targets.add( resolvePath(cwd, root) )
              ...
              cb = typeOf(cb) == "function" ? cb : Function.prototype
                ...
                return queue(this, () => new Promise(resolve=> {
                    ...
                    .then(() => new Promise(resolve => {
                          ...
                          cb(null, this.tree.nodes.get(query))
                    })
                    .catch(e => cb(e, null)))
                }))
            }
