        ...
        constructor: function(directory, { fruits, leaves }){
            ...
            .then(() => new Promise((resolve, reject) => {
                const walker = function *(){
                    ...
                    console.log( dbNodes.size, branches.size, leaves.size, fruits.size )
                    const n = dbNodes.get("/watches/black-bay-36/images/steel/03-snowflake-hands-and-black-polished-dial-dark.jpg")

                    console.log(n.parentNode.children.length, n.siblings.length)
